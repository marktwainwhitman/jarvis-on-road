...
echo ""
echo "La MAC del adaptador OBD-II y del BLE de LEDs ya vienen configuradas"
echo "por defecto en docker-compose.yml; solo necesitas crear un .env"
echo "(a partir de .env.example) si usas hardware distinto."
echo ""
echo "Para arrancar automaticamente al encender la Pi, copia y activa el servicio:"
echo "  sudo cp scripts/jarvis.service /etc/systemd/system/"
echo "  sudo systemctl daemon-reload"
echo "  sudo systemctl enable jarvis --now"
